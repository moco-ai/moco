...
- true: 長期的に覚えておくべき情報（例: ユーザーの名前、好み、設定、ルール、重要な決定事項、プロジェクト情報）
- false: このセッション/タスク限定の一時的な情報（例: 現在のファイルパス、一時的な作業内容、すぐに忘れてよい文脈）

重要: ユーザーが「覚えておいて」と言った情報は必ず shared=true にする。
